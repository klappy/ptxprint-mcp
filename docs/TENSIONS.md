...
| T-2026-09-05-D1s | D1' | depth-1 snippet picks a one-line callout ("Superseded.") when it is the first paragraph mentioning a term | prefer the first paragraph ≥ 80 chars, else fall through | next `src/docs.ts` cook |
