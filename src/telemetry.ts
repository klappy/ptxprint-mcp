...
export const WORKER_VERSION = "0.3.0"; // 0.3.0: docs() progressive disclosure (index/article/section/pointers); // 0.2.1: container released when a job returns; 0.2.0: docs() from the bundled canon (2026-09-05)
