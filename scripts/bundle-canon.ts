...
// Content hash, not git sha: the bundle must be byte-identical for the same canon
// regardless of which commit built it, or CI's staleness check can never pass.
